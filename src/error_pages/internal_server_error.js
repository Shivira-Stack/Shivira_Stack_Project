...
import InternalServerError from '../client/assets/images/Internal_Server_Error.svg';

function ClientInternalServerError() {
  const navigate = useNavigate();
    return (
        <div className={ErrorPages.uiErrorPage}>
            <img src={InternalServerError} alt='503_Maintenance' className={ErrorPages.uiThumbnail} />
...
export default ClientInternalServerError;
