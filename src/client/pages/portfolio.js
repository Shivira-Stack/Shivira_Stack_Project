        ...
        <>
            ...
            <section className={Globle.uiSection}>
                <div className="container">
                    <div className="row">
                        <div className="col-md-8">
                            <div className={Globle.uiSectionHeader}>
                                <h2 className={Globle.uiSectionTitle}>Our Portfolio | Creative Web & App Projects</h2>
                                <p className={Globle.uiSectionDesc}>Explore our portfolio of web, mobile, and design projects. From e-commerce to enterprise solutions, see how we deliver creative, scalable, and impactful results.</p>
                            </div>
                        </div>
                    </div>
                    <ClientTabSlider
                    ...
                    />
                    <ClientTabContent activeTab={activeTab} tabs={portfolioTabs} />
                </div>
            </section>
        </>
    );
