...
import BadGateway from '../client/assets/images/Bad_Gateway.svg';

function ClientBadGateway() {
  const navigate = useNavigate();
    return (
        <div className={ErrorPages.uiErrorPage}>
            <img src={BadGateway} alt='503_Maintenance' className={ErrorPages.uiThumbnail} />
...
export default ClientBadGateway;
