...
import Forbidden from '../client/assets/images/Forbidden.svg';

function ClientForbidden() {
    const navigate = useNavigate();
    return (
        <div className={ErrorPages.uiErrorPage}>
            <img src={Forbidden} alt='503_Maintenance' className={ErrorPages.uiThumbnail} />
...
export default ClientForbidden;
